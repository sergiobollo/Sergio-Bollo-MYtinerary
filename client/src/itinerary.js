            ...
            return ( <
                ...
                ol > {
                    this.props.itineraries.map((itinerary) =>
                        ...
                        value = { itinerary.title } > { itinerary.title }, { itinerary.username }, { itinerary.rating }, { itinerary.profilePicture }, { itinerary.duration }, { itinerary.price }, { itinerary.hashtags }, {
                            itinerary.activities.map((activity) => < ul > < li key = { activity } > { activity } < /li > < /ul > )
                        } < /li > )
                    } < /ol> < /
                    React.Fragment >
                )
